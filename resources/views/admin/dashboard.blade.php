...
@section('content')
  ...
  <a href="{{ route('admin.change-password') }}" style="background:#FFD700;color:#1a1a1a;padding:0.6rem 1.5rem;border-radius:8px;border:2px solid #1a1a1a;font-size:1rem;font-weight:600;text-decoration:none;">
    🔒 Change Password
  </a>
  </div>
</div>
