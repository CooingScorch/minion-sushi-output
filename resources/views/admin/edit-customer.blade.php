...
<div style="max-width:600px;margin:2rem auto;background:white;padding:2rem;border-radius:12px;border:2px solid #1a1a1a;box-shadow:4px 4px 0 #1a1a1a;">
    ...
    <form action="{{ route('admin.customer.update', $member->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="display:flex;gap:1rem;">
            ...
            <a href="{{ route('admin.customer-list') }}" style="background:#eee;color:#1a1a1a;padding:0.6rem 1.5rem;border-radius:8px;border:2px solid #1a1a1a;font-size:1rem;font-weight:600;text-decoration:none;">
                ← Cancel
            </a>
        </div>
