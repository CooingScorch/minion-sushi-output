    ...
    <table style="width:100%;border-collapse:collapse;min-width:600px;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #ddd;">
                <td style="padding:0.8rem;">{{ $member->id }}</td>
                <td style="padding:0.8rem;">{{ $member->name }}</td>
                <td style="padding:0.8rem;">{{ $member->gender ?? '-' }}</td>
                <td style="padding:0.8rem;">{{ $member->phone ?? '-' }}</td>
                <td style="padding:0.8rem;">{{ $member->birthday ?? '-' }}</td>
                <td style="padding:0.8rem;">{{ $member->email }}</td>
