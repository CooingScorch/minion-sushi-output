                    ...
                    <div class="item-grid">
                        <div class="menu-item solid-shadow" data-id="1" data-name="Sashimi" data-price="12.00">
                            ...
                            <div class="item-details">
                                ...
                                <a href="{{   url('menu/sashimi')   }}"><button class="btn btn-primary view-more-btn"><i class="fas fa-plus"></i>View More</button></a>
                            </div>
                        </div>

                        <div class="menu-item solid-shadow" data-id="2" data-name="Donburi" data-price="14.50">
                            <div class="item-img-cont">
                                <img src="{{ asset('img/donburi.jpg') }}">
                            </div>
                            <div class="item-details">
                                <div class="item-header">
                                ...
                                <a href="{{   url('menu/donburi')   }}"><button class="btn btn-primary view-more-btn"><i class="fas fa-plus"></i> View More</button></a>
                            </div>
                        </div>

                        <div class="menu-item solid-shadow" data-id="3" data-name="Sushi" data-price="16.00">
                            <div class="item-img-cont">
                                <img src="{{ asset('img/sushi.avif') }}">
                            </div>
                            <div class="item-details">
                                <div class="item-header">
                                ...
                                <a href="{{   url('menu/sushi')   }}"><button class="btn btn-primary view-more-btn"><i class="fas fa-plus"></i> View More</button></a>
                            </div>
                        </div>

                        <div class="menu-item solid-shadow" data-id="2" data-name="Noodless" data-price="14.50">
                            <div class="item-img-cont">
                                <img src="{{ asset('img/noodles.webp') }}">
                            </div>
                            <div class="item-details">
                                <div class="item-header">
                                ...
                                <a href="{{   url('menu/noodles')   }}"><button class="btn btn-primary view-more-btn"><i class="fas fa-plus"></i> View More</button></a>
                            </div>
                        </div>

                        <div class="menu-item solid-shadow" data-id="3" data-name="Drinks" data-price="16.00">
                            <div class="item-img-cont">
                                <img src="{{ asset('img/drinks.webp') }}">
                            </div>
                            <div class="item-details">
                                <div class="item-header">
                                ...
                                <a href="{{   url('menu/drinks')   }}"><button class="btn btn-primary view-more-btn"><i class="fas fa-plus"></i> View More</button></a>
                            </div>
                        </div>
