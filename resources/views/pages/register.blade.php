...
<form method="POST" action="/register">
    @csrf
    <input type="text" name="name" class="login-field" placeholder="👤 Full Name" value="{{ old('name') }}" required>
    ...
    <input type="email" name="email" class="login-field" placeholder="📧 Email" value="{{ old('email') }}" required>
