...
<nav class="navbar" id="navbar">
  ...
  <div class="nav-right">
    <div class="nav-table" onclick="if(typeof onTableTileClick==='function'){onTableTileClick();}else{window.location='{{ route('home') }}'}" style="cursor:pointer;" title="Change table">🪑 <span>Table</span> <span class="nav-tnum">{{ session('table', '—') }}</span></div>
    <a href="{{ route('waiter') }}" class="nav-waiter">🙋 <span>Call Waiter</span></a>
  </div>
</nav>
...
<div class="shell">
  ...
  <aside class="sidebar collapsed" id="sidebar" style="transition:none">
    <div class="sb-inner">
      ...
      <a href="{{ route('home') }}" class="sb-item {{ request()->routeIs('home') ? 'active' : '' }}">
        <span class="sb-ic">🏠</span> Home
      </a>
      <a href="{{ route('menu') }}" class="sb-item {{ request()->routeIs('menu') ? 'active' : '' }}">
        <span class="sb-ic">🍱</span> Menu
      </a>
      <a href="{{ route('cart') }}" class="sb-item {{ request()->routeIs('cart') ? 'active' : '' }}">
      ...
      <a href="{{ route('waiter') }}" class="sb-item {{ request()->routeIs('waiter') ? 'active' : '' }}">
        <span class="sb-ic">🙋</span> Call Waiter
      </a>
      <a href="{{ route('feedback') }}" class="sb-item {{ request()->routeIs('feedback') ? 'active' : '' }}">
        <span class="sb-ic">💬</span> Feedback
      </a>
      <a href="{{ route('contact') }}" class="sb-item {{ request()->routeIs('contact') ? 'active' : '' }}">
...
<nav class="mob-nav">
  <div class="mob-nav-inner">
    ...
    <a href="{{ route('menu') }}" class="mn-item {{ request()->routeIs('menu') ? 'active' : '' }}">
      <span class="mn-icon">🍱</span><span class="mn-lbl">Menu</span>
    </a>
    <a href="{{ route('cart') }}" class="mn-item {{ request()->routeIs('cart') ? 'active' : '' }}">
      <span class="mn-icon">🛒</span><span class="mn-lbl">Cart</span>
    </a>
    <a href="{{ route('profile') }}" class="mn-item {{ request()->routeIs('profile') ? 'active' : '' }}">
