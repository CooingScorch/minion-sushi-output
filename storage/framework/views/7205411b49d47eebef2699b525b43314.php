...
<div style="max-width:600px;margin:2rem auto;background:white;padding:2rem;border-radius:12px;border:2px solid #1a1a1a;box-shadow:4px 4px 0 #1a1a1a;">
    ...
    <h2 style="font-family:'Boogaloo',cursive;font-size:2rem;margin-bottom:1.5rem;">✏️ Edit Customer Info</h2>

    <form action="<?php echo e(route('admin.customer.update', $member->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="display:flex;gap:1rem;">
            ...
            <a href="<?php echo e(route('admin.customer-list')); ?>" style="background:#eee;color:#1a1a1a;padding:0.6rem 1.5rem;border-radius:8px;border:2px solid #1a1a1a;font-size:1rem;font-weight:600;text-decoration:none;">
                ← Cancel
            </a>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/admin/edit-customer.blade.php ENDPATH**/ ?>