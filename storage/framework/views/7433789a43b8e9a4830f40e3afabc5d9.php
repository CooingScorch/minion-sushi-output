...
<div class="contact-wrap">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(route('contact.store')); ?>" class="form-grid">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="text" name="phone" class="form-control" placeholder="Enter your phone number" value="<?php echo e(old('phone')); ?>" required>
            </div>
            ...
            <div>
                ...
                <textarea name="message" class="form-control" placeholder="Write your message here..." required><?php echo e(old('message')); ?></textarea>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/pages/contact.blade.php ENDPATH**/ ?>