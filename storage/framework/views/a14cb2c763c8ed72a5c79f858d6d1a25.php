...
<div style="padding:1.5rem; max-width: 800px; margin: 0 auto;">
    <h2 style="font-family:'Fredoka One',cursive; font-size:1.8rem; margin-bottom:1rem; color:#1a1a1a;">🍱 Add New Sushi</h2>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('admin.menuItem.add')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <div style="grid-column: span 2;">
                    ...
                    <input type="text" name="name" placeholder="e.g., Salmon Nigiri" required
                ...
                <div style="grid-column: span 2;">
                    ...
                    <textarea name="description" rows="4" placeholder="Describe the ingredients..."
                              style="width:100%; padding:0.8rem; border:2px solid #1a1a1a; border-radius:8px; font-size:1rem; box-shadow: 4px 4px 0px #1a1a1a; box-sizing:border-box; resize:vertical;"></textarea>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/admin/add-drop(add).blade.php ENDPATH**/ ?>