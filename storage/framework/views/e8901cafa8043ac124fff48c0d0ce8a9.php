...
<title>Minion Sushi · <?php echo $__env->yieldContent('title', 'Home'); ?></title>
...
@media(max-width:700px){
  ...
  /* Toast position */
  .toast { top:70px; right:0.75rem; font-size:0.9rem; padding:0.6rem 1rem; }
}
...
<div class="toast" id="toast">🙋 Waiter is on the way!</div>
...
<nav class="navbar" id="navbar">
  ...
  <a href="<?php echo e(route('home')); ?>" class="nav-logo">
    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Minion Sushi" onerror="this.style.display='none';this.parentNode.textContent='🍣'">
  </a>
  <div class="nav-brand">
    <div class="nav-title">Minion Sushi</div>
    <div class="nav-sub">Banana-Maki & More</div>
  </div>
  <div class="nav-right">
    <div class="nav-table" onclick="if(typeof onTableTileClick==='function'){onTableTileClick();}else{window.location='<?php echo e(route('home')); ?>'}" style="cursor:pointer;" title="Change table">🪑 <span>Table</span> <span class="nav-tnum"><?php echo e(session('table', '—')); ?></span></div>
    <a href="<?php echo e(route('waiter')); ?>" class="nav-waiter">🙋 <span>Call Waiter</span></a>
  </div>
</nav>
...
<div class="shell">
  ...
  <aside class="sidebar collapsed" id="sidebar" style="transition:none">
    <div class="sb-inner">
      <div class="sb-sec">Dining</div>
      <a href="<?php echo e(route('home')); ?>" class="sb-item <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
        <span class="sb-ic">🏠</span> Home
      </a>
      <a href="<?php echo e(route('menu')); ?>" class="sb-item <?php echo e(request()->routeIs('menu') ? 'active' : ''); ?>">
        <span class="sb-ic">🍱</span> Menu
      </a>
      <a href="<?php echo e(route('cart')); ?>" class="sb-item <?php echo e(request()->routeIs('cart') ? 'active' : ''); ?>">
        <span class="sb-ic">🛒</span> Cart
      </a>
      <div class="sb-div"></div>
      <div class="sb-sec">Account</div>
      <a href="<?php echo e(route('profile')); ?>" class="sb-item <?php echo e(request()->routeIs('profile') ? 'active' : ''); ?>">
        <span class="sb-ic">👤</span> Profile
      </a>
      <a href="<?php echo e(route('waiter')); ?>" class="sb-item <?php echo e(request()->routeIs('waiter') ? 'active' : ''); ?>">
        <span class="sb-ic">🙋</span> Call Waiter
      </a>
      <a href="<?php echo e(route('feedback')); ?>" class="sb-item <?php echo e(request()->routeIs('feedback') ? 'active' : ''); ?>">
        <span class="sb-ic">💬</span> Feedback
      </a>
      <a href="<?php echo e(route('contact')); ?>" class="sb-item <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">
        <span class="sb-ic">📞</span> Contact Us
      </a>
      <div class="sb-bottom">
        <div class="sb-div"></div>
...
<nav class="mob-nav">
  <div class="mob-nav-inner">
    <a href="<?php echo e(route('home')); ?>" class="mn-item <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
      <span class="mn-icon">🏠</span><span class="mn-lbl">Home</span>
    </a>
    <a href="<?php echo e(route('menu')); ?>" class="mn-item <?php echo e(request()->routeIs('menu') ? 'active' : ''); ?>">
      <span class="mn-icon">🍱</span><span class="mn-lbl">Menu</span>
    </a>
    <a href="<?php echo e(route('cart')); ?>" class="mn-item <?php echo e(request()->routeIs('cart') ? 'active' : ''); ?>">
      <span class="mn-icon">🛒</span><span class="mn-lbl">Cart</span>
    </a>
    <a href="<?php echo e(route('profile')); ?>" class="mn-item <?php echo e(request()->routeIs('profile') ? 'active' : ''); ?>">
      <span class="mn-icon">👤</span><span class="mn-lbl">Profile</span>
    </a>
  </div>
</nav>
...
</html><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/layouts/app.blade.php ENDPATH**/ ?>