<?php $__env->startSection('title', 'Call Waiter'); ?>
...
<div class="waiter-page">
  ...
  <div style="display:flex;flex-direction:column;gap:1rem;">
    ...
    <button class="waiter-call-btn <?php echo e(session('table') ? '' : 'disabled'); ?>" id="callBtn" onclick="doCallWaiter()">
    ...
    <div class="waiter-status-card">
      <div class="waiter-status-row">
        <div class="ws-ic">🪑</div>
        <div><div class="ws-label">Table</div><div class="ws-val"><?php echo e(session('table') ? 'Table ' . session('table') : '—'); ?></div></div>
      </div>
      <div class="waiter-status-row">
        <div class="ws-ic">👥</div>
        <div><div class="ws-label">Guests</div><div class="ws-val"><?php echo e(session('pax') ? session('pax') . ' Guests' : '—'); ?></div></div>
      </div>
      <div class="waiter-status-row">
        <div class="ws-ic">🕐</div>
...
let wCool = false;
const hasTable = <?php echo e(session('table') ? 'true' : 'false'); ?>;
...
function doCallWaiter(){
  ...
  fetch('<?php echo e(route("waiter.call")); ?>', {
    method: 'POST',
    headers: {'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},
    body: JSON.stringify({table: <?php echo e(session('table') ?? 'null'); ?>})
  });
}
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/pages/waiter.blade.php ENDPATH**/ ?>