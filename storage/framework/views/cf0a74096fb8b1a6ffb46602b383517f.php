...
<div class="overlay" id="paxOverlay" style="z-index:600;pointer-events:none;">
  <div class="pax-modal">
    ...
    <div class="pax-grid">
      <?php $__currentLoopData = [1,2,3,4,5,6,7,8]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <button class="pax-btn <?php echo e(session('pax', 2) == $n ? 'selected' : ''); ?>"
              onclick="selectPax(<?php echo e($n); ?>)"><?php echo e($n); ?></button>
      ...
      <div class="tbl-floorplan">
        <svg id="restaurantSVG" viewBox="0 0 560 574" xmlns="http://www.w3.org/2000/svg"
          ...
          <!-- LEFT BENCH T1-T4 -->
             ...
             data-cap="2" data-min="1" data-max="2" data-status="<?php echo e(in_array(1, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="51" y="104" text-anchor="middle" font-family="Nunito,sans-serif" font-size="11" font-weight="800" fill="#999">2 pax</text>
             ...
             data-cap="2" data-min="1" data-max="2" data-status="<?php echo e(in_array(2, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="51" y="234" text-anchor="middle" font-family="Nunito,sans-serif" font-size="11" font-weight="800" fill="#999">2 pax</text>
             ...
             data-cap="4" data-min="1" data-max="4" data-status="<?php echo e(in_array(3, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="51" y="364" text-anchor="middle" font-family="Nunito,sans-serif" font-size="11" font-weight="800" fill="#999">4 pax</text>
             ...
             data-cap="6" data-min="1" data-max="6" data-status="<?php echo e(in_array(4, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
          ...
          <!-- BOOTHS LEFT T5-T7 -->
             ...
             data-cap="6" data-min="2" data-max="6" data-status="<?php echo e(in_array(5, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="182" y="103" text-anchor="middle" font-family="Nunito,sans-serif" font-size="10" font-weight="800" fill="#7a6040">6 pax</text>
             ...
             data-cap="6" data-min="2" data-max="6" data-status="<?php echo e(in_array(6, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="182" y="233" text-anchor="middle" font-family="Nunito,sans-serif" font-size="10" font-weight="800" fill="#7a6040">6 pax</text>
             ...
             data-cap="6" data-min="2" data-max="6" data-status="<?php echo e(in_array(7, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
          ...
          <!-- BOOTHS RIGHT T8-T10 -->
             ...
             data-cap="6" data-min="2" data-max="6" data-status="<?php echo e(in_array(8, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="378" y="103" text-anchor="middle" font-family="Nunito,sans-serif" font-size="10" font-weight="800" fill="#7a6040">6 pax</text>
             ...
             data-cap="6" data-min="2" data-max="6" data-status="<?php echo e(in_array(9, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="378" y="233" text-anchor="middle" font-family="Nunito,sans-serif" font-size="10" font-weight="800" fill="#7a6040">6 pax</text>
             ...
             data-cap="6" data-min="2" data-max="6" data-status="<?php echo e(in_array(10, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
          ...
          <!-- RIGHT BENCH T11-T14 -->
             ...
             data-cap="2" data-min="1" data-max="2" data-status="<?php echo e(in_array(11, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="505" y="104" text-anchor="middle" font-family="Nunito,sans-serif" font-size="11" font-weight="800" fill="#999">2 pax</text>
             ...
             data-cap="2" data-min="1" data-max="2" data-status="<?php echo e(in_array(12, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="505" y="234" text-anchor="middle" font-family="Nunito,sans-serif" font-size="11" font-weight="800" fill="#999">2 pax</text>
             ...
             data-cap="4" data-min="1" data-max="4" data-status="<?php echo e(in_array(13, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
            ...
            <text x="505" y="364" text-anchor="middle" font-family="Nunito,sans-serif" font-size="11" font-weight="800" fill="#999">4 pax</text>
             ...
             data-cap="6" data-min="1" data-max="6" data-status="<?php echo e(in_array(14, $occupiedTables ?? []) ? 'occupied' : 'available'); ?>">
...
const OCCUPIED_TABLES = new Set(<?php echo e(json_encode($occupiedTables ?? [])); ?>);

// My own tables from server (for pre-selecting on page load)
const MY_TABLES = <?php echo e(json_encode($mySession ? $mySession->all_tables : [])); ?>;
const MY_PRIMARY = <?php echo e($mySession ? $mySession->primary_table : 'null'); ?>;

document.addEventListener('DOMContentLoaded', ()=>{
  // Lock tiles only when table is fully confirmed (not just pax)
  if(<?php echo e(session('table_set') ? 'true' : 'false'); ?>) lockTiles();
});
...
function saveTables(allTables,primary){
  ...
  fetch('/api/table',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},
...
function cancelSessionYes(){
  Promise.all([
    fetch('<?php echo e(route("pax.clear")); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({})}),
    fetch('<?php echo e(route("table.clear")); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({})})
  ]).then(()=>{
    ...
    <div class="card-body">
      <div class="sess-grid">
        <div class="sess-tile sess-tile-click" id="guestTile" onclick="onGuestTileClick()" title="Change guests">
          ...
          <div>
            <div class="sess-v" id="guestCount"><?php echo e(session('pax', '—')); ?></div>
        ...
        <div class="sess-tile sess-tile-click" id="tableTile" onclick="onTableTileClick()" title="Change table">
          <span class="sess-ic">🪑</span>
          <div>
            <div class="sess-v" id="tableDisplay"><?php echo e(session('table', '—')); ?></div>
...
<div onclick="promptCancelSession()" class="dine-in-banner dine-in-active" id="dineInBar" style="cursor:pointer;">
  ...
  <div class="dine-in-text">
    ...
    <div class="dine-in-s" style="color:#166534;opacity:0.8;">👥 <?php echo e(session('pax', '—')); ?> Guests &nbsp;·&nbsp; 🪑 Table <?php echo e(session('table', '—')); ?></div>
...
<div>
  ...
  <div class="g2s">
    <a href="<?php echo e(route('menu')); ?>" class="qa b"><div class="qa-ic">🍱</div><div class="qa-t">View Menu</div><div class="qa-d">Browse & add to order</div></a>
    <a href="<?php echo e(route('cart')); ?>" class="qa o"><div class="qa-ic">🛒</div><div class="qa-t">My Cart</div><div class="qa-d">Add Items To Your Cart Now!</div></a>
  </div>
</div>
...
// ── PAX ──
let selectedPax = <?php echo e(session('pax', 0)); ?>;
...
// GPS always fires AFTER <?php echo $__env->yieldContent('scripts'); ?>, so this callback is always registered in time.
...
function confirmPax(){
  ...
  fetch('<?php echo e(route("pax.save")); ?>',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>'},body:JSON.stringify({pax:selectedPax})})
  .then(()=>{
    hideOverlay('paxOverlay');
    document.getElementById('cancelSessionBtn').style.visibility='visible';
    paxFromDineIn=false;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/pages/home.blade.php ENDPATH**/ ?>