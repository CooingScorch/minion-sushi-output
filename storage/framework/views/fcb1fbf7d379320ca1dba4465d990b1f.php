...
<aside class="sidebar collapsed" id="sidebar" style="transition:none">
  <div class="sb-inner">
    ...
    <a href="<?php echo e(route('AdminDashboard')); ?>" class="sb-item <?php echo e(request()->routeIs('AdminDashboard') ? 'active' : ''); ?>">
      <span class="sb-ic">📊</span> Dashboard
    </a>
    <a href="<?php echo e(route('admin.customer-list')); ?>" class="sb-item">
      <span class="sb-ic">👥</span> Customer List
    </a>
    <a href="<?php echo e(route('admin.staff-list')); ?>" class="sb-item">
      <span class="sb-ic">👔</span> Staff List
    </a>
    <a href="<?php echo e(route('admin.add-drop-menu')); ?>" class="sb-item">
      <span class="sb-ic">🍱</span> Add/Drop Menu
    </a>
    <a href="<?php echo e(route('admin.order-log')); ?>" class="sb-item">
...
<nav class="mob-nav">
  <div class="mob-nav-inner">
    <a href="<?php echo e(route('AdminDashboard')); ?>" class="mn-item <?php echo e(request()->routeIs('AdminDashboard') ? 'active' : ''); ?>">
      <span class="mn-icon">📊</span><span class="mn-lbl">Dashboard</span>
    </a>
    <a href="<?php echo e(route('admin.customer-list')); ?>" class="mn-item">
      <span class="mn-icon">👥</span><span class="mn-lbl">Customers</span>
    </a>
    <a href="<?php echo e(route('admin.staff-list')); ?>" class="mn-item">
      <span class="mn-icon">👔</span><span class="mn-lbl">Staff</span>
    </a>
    <a href="<?php echo e(route('admin.add-drop-menu')); ?>" class="mn-item">
      <span class="mn-icon">🍱</span><span class="mn-lbl">Menu</span>
    </a>
    <a href="<?php echo e(route('admin.order-log')); ?>" class="mn-item">
      <span class="mn-icon">🧾</span><span class="mn-lbl">Orders</span>
    </a>
    <a href="<?php echo e(route('admin.order.items')); ?>" class="mn-item">
...
</html><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/layouts/admin.blade.php ENDPATH**/ ?>