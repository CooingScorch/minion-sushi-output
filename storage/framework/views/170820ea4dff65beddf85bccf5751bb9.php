    ...
    <table style="width:100%;border-collapse:collapse;min-width:600px;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #ddd;">
                <td style="padding:0.8rem 1rem;"><?php echo e($customer->id); ?></td>
                <td style="padding:0.8rem 1rem;"><?php echo e($customer->name); ?></td>
                <td style="padding:0.8rem 1rem;"><?php echo e($customer->gender); ?></td>
                <td style="padding:0.8rem 1rem;"><?php echo e($customer->phone); ?></td>
                <td style="padding:0.8rem 1rem;"><?php echo e($customer->birthday); ?></td>
                <td style="padding:0.8rem 1rem;"><?php echo e($customer->email); ?></td>
                <td style="padding:0.8rem;text-align:center;white-space:nowrap;">
                    ...
                    <form action="<?php echo e(route('admin.customer.delete', $customer->id)); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/admin/customer-list.blade.php ENDPATH**/ ?>