...
<div class="login-box">
    ...
    <?php if(session('error')): ?>
        <div class="login-err" style="display:block;">❌ <?php echo e(session('error')); ?></div>
    <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/pages/forgot-password.blade.php ENDPATH**/ ?>