    ...
    <div class="app-container">
        ...
        <main class="main-content">
            <div class="content-header">
                <h1 class="page-title">Donburi</h1>
                <p class="page-subtitle">Discover our delicious donburi!</p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minion-sushi-output\resources\views/menu/donburi.blade.php ENDPATH**/ ?>